=== Product Screenshot ===
Contributors: hasthemes, madhusudandev, zenaulislam, tarekht, aslamhasib
Tags: screenshot, shortcode, product preview, popup, gallery
...
== Description ==
The Product Screenshot plugin could be the right solution for you if you're seeking for a WordPress plugin to add product screenshots into your posts and pages. It's a powerful plugin that makes showcasing product screenshot gallery effortless.

It's always important to show your customers what they are buying. One of the best ways to do this is by adding screenshots of products in posts and pages. This WordPress plugin auto-generates a shortcode and makes it easy for you to insert screenshots into posts or pages automatically through that shortcode and thus saves your time and effort!

This excellent WordPress screenshot plugin comes with a plethora of features at your disposal. From the settings panel, you can set item column, space (in pixel), bottom space (in pixel), image height, title typography, etc.  After that, you can display the screenshots on any post or page easily by placing a shortcode.


[Live Demo](https://wpdownloadio.com/screenshots/)

== Key Features: ==

* Display Product screenshot as gallery
* Column Option
* Screenshot item option
* Load item option
* Screenshot title show/hide option
* Custom column gap option
* Custom Image size option
...
= Version: 1.0.3 - Date: 2022-11-07 =
* Capability With the Latest WordPress version

= Version: 1.0.2 - Date: 2022-09-19 =
* Added: Recommendations menu.

= Version: 1.0.1 - Date: 2021-08-03 =
...
== Installation ==
This section describes how to install the Product Screenshot plugin and get it working.

= 1) Install =

1. Go to the WordPress Dashboard "Add New Plugin" section.
2. Search For "Product Screenshot".
3. Install, then Activate it.

= OR: =
1. Unzip (if it is zipped) and Upload `product-screenshot` folder to the `/wp-content/plugins/` directory
2. Activate the plugin through the 'Plugins' menu in WordPress

= 2) Configure =
1. After install and activate the plugin you will get a 
menu "Product Screenshot" on the Dashboard menu.
2. Add New Product screenshot and relax!

== Screenshots ==
1. Product Screenshot Gallery
2. Product Screenshot Shortcode
3. Product Screenshot Upload
4. Product Screenshot Settings